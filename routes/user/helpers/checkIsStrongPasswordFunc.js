...
function checkIsStrongPasswordFunc(req, res, next) { //method which checks that the variable must include 1 lowercase, 1 uppercase, 1 special character, 1 number, and a length of 8
  //let errorObj = {};
